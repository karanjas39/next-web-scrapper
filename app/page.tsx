function HomePage() {
  return (
    <>
      <div className="min-h-screen flex items-center justify-center flex-col p-6">
        ...
        <div className="text-left bg-gray-100 p-4 rounded-lg shadow-md w-full max-w-2xl">
          ...
          <div className="bg-black text-white p-4 rounded-lg my-4">
            <code className="text-wrap text-xs md:text-sm">
          ...
          <ul className="list-disc list-inside">
            ...
            <li>
              <strong>reviewType</strong>: The type of review you&lsquo;re
              looking for (e.g., Academics, College Infrastructure, or
              Placements).
            </li>
            <li>
      ...
      <div className="w-full bg-gray-100 p-4 flex items-end justify-end flex-col gap-1">
        <div>
          Developed by{" "}
          <a
        ...
        <div className="font-bold text-sm">
          <button className="px-3 py-2 rounded-md bg-black text-white">
            <a href="mailto:dhillonjaskaran4486@gmail.com" target="_blank">
              Send Email
            </a>
          </button>
        </div>
